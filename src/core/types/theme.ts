export interface AppTheme {
  ...
  // Efeito de animação de fundo (ex: 'matrix' = chuva de binários)
  effect?: string;
  rainDensity?: number; // % — quantidade de chuva (100 = padrão)
  rainOpacity?: number; // % — opacidade da chuva (90 = padrão)
  rainSpeed?: number; // % — velocidade de queda (100 = padrão)

  // Permite acesso indexado dinâmico por chave
  [key: string]: string | number | undefined;
}

/** Valores padrão dos ajustes da chuva de binários. */
export const RAIN_DEFAULTS: {
  density: number;
  opacity: number;
  speed: number;
} = { density: 100, opacity: 90, speed: 100 };

/**
 * Tema com efeito de animação (chuva de binários).
 * Aceita tanto a flag `effect` quanto o nome "Matrix", para não quebrar
 * temas customizados salvos antes da flag existir.
 */
export function isRainTheme(theme: AppTheme): boolean {
  return theme.effect === "matrix" || theme.name === "Matrix";
}

export function isFireTheme(theme: AppTheme): boolean {
  return theme.effect === "fire" || theme.name === "FireTheme";
}

export function isIceTheme(theme: AppTheme): boolean {
...
export const presetThemes: AppTheme[] = [
  ...
  },
  {
    ...
    textFaint: "#006618",
    textSpecial: "#66ff99",
    borderSubtle: "rgba(0, 255, 65, 0.10)",
    borderPanel: "rgba(0, 255, 65, 0.18)",
    terminalBg: "#000000",
    terminalFg: "#00ff41",
    terminalCursorLocal: "#00ff41",
    terminalCursorSsh: "#33ff77",
    terminalSelection: "rgba(0, 255, 65, 0.25)",
    btnPrimaryBg: "#00cc33",
    btnPrimaryText: "#000000",
    btnPrimaryHover: "#00b330",
    btnSecondaryBg: "#0d1a0d",
    btnSecondaryText: "#00ff41",
    btnSecondaryHover: "#0f260f",
    btnDangerBg: "#cc0000",
    btnDangerText: "#00ff41",
    btnDangerHover: "#990000",
    btnSuccessBg: "#00cc33",
    btnSuccessText: "#000000",
    btnGlassBg: "rgba(0, 255, 65, 0.06)",
    btnGlassText: "#00ff41",
    btnGlassHover: "rgba(0, 255, 65, 0.14)",
    btnBorder: "rgba(0, 255, 65, 0.20)",
  },
  {
    name: "FireTheme",
    effect: "fire",
    ...
    textFaint: "#733f2e",
    textSpecial: "#ffe082",
    borderSubtle: "rgba(255, 87, 34, 0.12)",
    borderPanel: "rgba(255, 87, 34, 0.22)",
    terminalBg: "#090403",
    terminalFg: "#ffe4d6",
    terminalCursorLocal: "#ff5722",
    terminalCursorSsh: "#ffab40",
    terminalSelection: "rgba(255, 87, 34, 0.30)",
    btnPrimaryBg: "#ff5722",
    btnPrimaryText: "#ffffff",
    btnPrimaryHover: "#f4511e",
    btnSecondaryBg: "#200d08",
    btnSecondaryText: "#ffab40",
    btnSecondaryHover: "#2d130b",
    btnDangerBg: "#d32f2f",
    btnDangerText: "#ffffff",
    btnDangerHover: "#b71c1c",
    btnSuccessBg: "#ef6c00",
    btnSuccessText: "#ffffff",
    btnGlassBg: "rgba(255, 87, 34, 0.08)",
    btnGlassText: "#ff9800",
    btnGlassHover: "rgba(255, 87, 34, 0.16)",
    btnBorder: "rgba(255, 87, 34, 0.25)",
  },
  {
    name: "IceTheme",
    effect: "ice",
    ...
    borderPanel: "rgba(0, 180, 216, 0.22)",
    terminalBg: "#03080f",
    terminalFg: "#e0f7fa",
    terminalCursorLocal: "#00b4d8",
    terminalCursorSsh: "#90e0ef",
    terminalSelection: "rgba(0, 180, 216, 0.30)",
    btnPrimaryBg: "#00b4d8",
    btnPrimaryText: "#03080f",
    btnPrimaryHover: "#0096c7",
    btnSecondaryBg: "#0b1c30",
    btnSecondaryText: "#90e0ef",
    btnSecondaryHover: "#0f2845",
    btnDangerBg: "#c62828",
    btnDangerText: "#ffffff",
    btnDangerHover: "#b71c1c",
    btnSuccessBg: "#0077b6",
    btnSuccessText: "#ffffff",
    btnGlassBg: "rgba(0, 180, 216, 0.08)",
    btnGlassText: "#90e0ef",
...
export function applyThemeToDom(theme: AppTheme): void {
  ...
  // Hover dinâmico
  const itemHover =
    theme.bgItemHover || (isLight ? "#e2e8f0" : "rgba(255, 255, 255, 0.06)");
  const tabHover =
    theme.bgTabHover || (isLight ? "#e2e8f0" : "rgba(255, 255, 255, 0.05)");
  ...
  const subtleBorder =
    theme.borderSubtle || (isLight ? "#e2e8f0" : "rgba(255, 255, 255, 0.08)");
  const panelBorder =
    theme.borderPanel || (isLight ? "#cbd5e1" : "rgba(255, 255, 255, 0.12)");
  ...
  r.setProperty(
    ...
    theme.btnPrimaryText ||
      (isLightColor(theme.btnPrimaryBg || theme.accentPrimary)
        ? "#0f172a"
        : "#ffffff"),
  );
  r.setProperty(
    "--btn-primary-hover",
    theme.btnPrimaryHover || theme.btnPrimaryBg || theme.accentPrimary,
  );

  r.setProperty("--btn-secondary-bg", theme.btnSecondaryBg || theme.bgItem);
  r.setProperty(
    "--btn-secondary-text",
    theme.btnSecondaryText || theme.textMuted,
  );
  r.setProperty(
    "--btn-secondary-hover",
    theme.btnSecondaryHover || theme.bgItemHover || itemHover,
  );
  ...
  r.setProperty(
    "--btn-success-bg",
    theme.btnSuccessBg || theme.accentSecondary,
  );
  r.setProperty(
    "--btn-success-text",
    theme.btnSuccessText ||
      (isLightColor(theme.btnSuccessBg || theme.accentSecondary)
        ? "#0f172a"
        : "#ffffff"),
  );
  ...
  const defaultBtnBorder =
    theme.btnBorder || (isLight ? "#cbd5e1" : "rgba(255, 255, 255, 0.15)");
