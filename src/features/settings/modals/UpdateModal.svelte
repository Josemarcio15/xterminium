      ...
      <div class="py-1 flex flex-col gap-2.5">
        ...
        {:else}
          ...
          {#if info.releaseNotes}
            <div
              class="p-3 bg-black/20 rounded-xl border border-(--border-subtle) max-h-36 overflow-y-auto text-[11px] text-(--text-muted) font-mono whitespace-pre-wrap select-text"
            >
              {info.releaseNotes}
            </div>
          {/if}
